 ...
 * 
 */
@WebServiceClient(name = "WebServerService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/echo?wsdl")
    ...
    extends Service
{
    ...
    public Echo getWebServerPort() {
        return super.getPort(new QName("http://server/", "WebServerPort"), Echo.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServerPort")
    public Echo getWebServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "WebServerPort"), Echo.class, features);
    }

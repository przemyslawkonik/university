 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://server.asd/", wsdlLocation = "http://localhost:8080/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://server.asd/", "ServerService");
    ...
    public Echo getServerPort() {
        return super.getPort(new QName("http://server.asd/", "ServerPort"), Echo.class);
    }
     ...
     */
    @WebEndpoint(name = "ServerPort")
    public Echo getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.asd/", "ServerPort"), Echo.class, features);
    }
